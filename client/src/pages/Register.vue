    ...
    <div class="row q-mt-lg">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 q-px-sm">
        <div class="column">
          ...
          <q-input dense outlined class="q-mb-sm" v-model="form.tLicencia" placeholder="Capitan"
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 q-px-sm">
        <div class="column">
          ...
          <q-input dense outlined class="q-mb-sm" v-model="form.examenD" placeholder="Examen 01"
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 q-px-sm">
        <div class="column">
          ...
          <q-input dense outlined class="q-mb-sm" v-model="form.gestion" placeholder="€30"
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 q-px-sm">
        <div class="column">
          ...
          <q-input dense outlined class="q-mb-sm" v-model="form.tasa" placeholder="€50"
